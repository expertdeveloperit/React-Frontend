  ...
  var g = e.rangy || null,
    ...
    b = (function () {
      var d = function (q) {
        ...
        m.className += ` ${n.cssClasses.editor} ${n.cssClasses.editor}-${n.mode}`;
        n.tags = n.tags || {};
        if (n.tags.outerLevel) {
          n.tags.outerLevel = n.tags.outerLevel.concat([n.tags.paragraph, n.tags.horizontalRule]);
        }
        this.settings = n;
        this.element = m;
        m.medium = this;
      ...
      d.prototype = {
          ...
          if (!l && r.length < 1 && n < 2) {
            ...
            if (u.placeholder.length > 0) {
              if (!p.setup) {
                ...
                p.className =
                  `${u.cssClasses.placeholder} ${u.cssClasses.placeholder}-${u.mode}`;
          ...
          a.traverseAll(k, {
            element(E, z, C, A) {
              ...
              if (C === 1 && y[D] !== undefined) {
                s = false;
              } else if (C > 1 && v[D] !== undefined) {
                s = false;
              }
              if (s) {
                if (e.getComputedStyle(E, null).getPropertyValue('display') === 'block') {
                  if (q.length > 0 && q !== D) {
                    a.changeTag(E, q);
                  }
                  if (C > 1) {
        ...
        insertHtml(l, o, m) {
          let k = new d.Html(this, l).insert(this.settings.beforeInsertHtml),
            n = k[k.length - 1];
          if (m === true) {
        ...
        splitAtCaret() {
          ...
          let k = e.getSelection || h.selection,
            q = k(),
            r = q.focusOffset,
            p = q.focusNode,
            m = this.element,
        ...
        bold() {
          ...
          new d.Element(this, 'bold').setClean(false).invoke(this.settings.beforeInvokeElement);
          return this;
        },
        underline() {
          switch (this.settings.mode) {
        ...
        italicize() {
          ...
          new d.Element(this, 'italic').setClean(false).invoke(this.settings.beforeInvokeElement);
          return this;
        },
        quote() {
          return this;
          ...
          let p = this.value(),
            ...
            o = function (u) {
              ...
              if (u.length > 0) {
                ...
                new d.Html(t, u).setClean(false).insert(n.beforeInsertHtml, true);
                t.clean();
                t.placeholders();
              }
            };
      ...
      (function (l, k, n) {
        function m(o) {
          if (o.hasOwnProperty('target') && o.target.getAttribute('contenteditable') === 'false') {
        ...
        l.Action.prototype = {
          ...
          destroy() {
            const o = this.medium.element;
            a
              .removeEvent(o, 'focus', this.handledEvents.focus)
          ...
          enterKey(v) {
            ...
            if (o.shift) {
              ...
              if (
                ...
                u = a.text(p) === '' && p.nodeName.toLowerCase() === s.tags.paragraph;
                if (u && r.length >= 2) {
                  x = r[r.length - 2];
          ...
          backspaceOrDeleteKey(s) {
            let v = this.medium,
              u = v.cursor,
              r = v.settings,
              p = v.element;
            if (r.onBackspaceOrDelete !== undefined) {
              const w = r.onBackspaceOrDelete.call(v, s, p);
              if (w) {
                return;
              }
            }
            ...
            if (
              ...
              p.removeChild(o);
              p.removeChild(q);
            } else if (p.childNodes.length === 1 && o && !a.text(o).length) {
          ...
          preserveElementFocus() {
            const w = k.getSelection ? k.getSelection().anchorNode : document.activeElement;
            if (w) {
              let x = this.medium,
                o = x.cache,
                p = x.element,
      ...
      (function (k) {
        k.Drag = function (m) {
          this.medium = m;
          let o = this,
            l = this.iconSrc.replace(/[{][{]([a-zA-Z]+)[}][}]/g, (q, p) => {
        ...
        k.Drag.prototype = {
          ...
          handleDragend() {
            ...
            a.addEvent(
              this.icon,
              'dragend',
              (this.handledEvents.dragend = h.body.ondragend = function (m) {
                if (l.protectedElement === null) {
                  return;
                }
                setTimeout(() => {
        ...
        k.Html.prototype = {
          insert(n, m) {
            if (k.activeElement === this.medium.element) {
              ...
              const l = this.injector.inject(this.html, m);
              if (this.clean) {
                this.medium.clean();
                this.medium.placeholders();
              }
      ...
      (function (k) {
        ...
        k.Injector.prototype = {
          inject(n) {
            ...
            let r = h.getElementById('Medium-wedge'),
              q = r.parentNode,
              o = 0;
          ...
          insertHTML(r, t) {
            ...
            if (e.getSelection) {
              ...
              if (n.getRangeAt && n.rangeCount) {
                ...
                o.innerHTML = r;
                let u = h.createDocumentFragment(),
                  p,
                  m;
            ...
            } else if ((n = h.selection) && n.type != 'Control') {
              const q = n.createRange();
              q.collapse(true);
      ...
      (function (k) {
        ...
        k.Selection.prototype = {
          saveSelection() {
            ...
            } else if (h.selection && h.selection.createRange) {
      ...
      (function (k) {
        ...
        k.Toolbar.prototype = {
          ...
          html:
            '<div class="Medium-toolbar">				<div class="Medium-tail-outer">					<div class="Medium-tail-inner"></div>				</div>				<div id="Medium-buttons"></div>				<table id="Medium-options">					<tbody>						<tr>						</tr>					</tbody>				</table>			</div>',
          setup() {
            this.handleScroll().handleMouseup().handleKeyup();
          },
          destroy() {
            a
              .removeEvent(e, 'scroll', this.handledEvents.scroll)
          ...
          goToSelection() {
            ...
            if (n !== null) {
              if (n.range.startOffset === n.range.endOffset && !n.text) {
                ...
                l.opacity = 1;
                l.top = `${o - 65}px`;
                l.left = `${n.boundary.left + n.boundary.width / 2 - m.clientWidth / 2}px`;
                this.active = true;
              }
            }
          },
      ...
      d.Utilities = {
        ...
        isEventSupported(m, k) {
          k = `on${k}`;
          let n = h.createElement(m.tagName),
            l = k in n;
          if (!l) {
        ...
        encodeHtml(k) {
          return h.createElement('a').appendChild(h.createTextNode(k)).parentNode.innerHTML;
        },
        text(k, l) {
          if (l !== undefined) {
            if (k === null) {
        ...
        baseAtCaret(m) {
          ...
          const n = e.getSelection ? e.getSelection() : document.selection;
          if (n.rangeCount) {
            let l = n.getRangeAt(0),
              k = l.endContainer;
            switch (k.nodeType) {
              case 3:
