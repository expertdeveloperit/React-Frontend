...
class SignUp extends Component {
  ...
  componentWillReceiveProps(nextProps, nextState) {
    if (this.props != nextProps) {
      ...
      if (nextProps.signupdata.fetchSignUp.success === true) {
        console.log('nextProps in if', nextProps);
        this.setState({
          successMessage: nextProps.signupdata.fetchSignUp.message,
          errorMessage: '',
        });
      } else if (nextProps.signupdata.fetchSignUp.error === true) {
        console.log('nextProps in else if', nextProps);
        this.setState({
          successMessage: '',
          errorMessage: nextProps.signupdata.fetchSignUp.message,
        });
      }
    }
  }
...
email is not a valid input --password is not numeric and  of 4 digits */
  ...
  render() {
    ...
    if (this.state.successMessage) {
      ...
      res_received = (
        <span className="response errorResponse">
      ...
      <div className="signUp_section">
        ...
        <div className="signUp_input">
          <form onSubmit={this.handleSignUp.bind(this)}>
            ...
            <div className="form-group fillarea" />
            <div className="form-group text-right">
              ...
              <input
                ...
                data-placement="top"
                title="SignUp"
                className={isEnabled == true ? 'submit_button signup_submit' : 'IMDisabled'}
                disabled={!isEnabled}
              />
            </div>
          </form>
