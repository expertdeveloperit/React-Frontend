...
const listWithNoDrag = [
  {
    content: (
      <div>
        test1<input type="text" className="no-drag" />
      </div>
    ),
  },
  {
    content: (
      <div>
        test2<input type="text" className="no-drag" />
      </div>
    ),
  },
  {
    content: (
      <div>
        test3<input type="text" className="no-drag" />
      </div>
    ),
  },
]
...
const listWithLinks = [
  {
    content: <a href="http://www.google.fr">google</a>,
    classes: ["test", "bigger"],
  },
  { content: <a href="http://www.yahoo.fr">yahoo</a>, classes: ["test"] },
  {
    content: <a href="http://www.thomschell.com">my website</a>,
    classes: ["test"],
  },
]
