...
var DragSortableList = (function(_React$Component) {
  ...
  function DragSortableList(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (DragSortableList.__proto__ || Object.getPrototypeOf(DragSortableList))
        .call(this, props),
    )
  ...
  _createClass(DragSortableList, [
      ...
      value: function componentDidMount() {
        ...
        var ignoreNoDrag = function ignoreNoDrag(fun) {
          return function(event) {
            var mouseElement = document.elementFromPoint(
              event.clientX,
              event.clientY,
            )
        ...
        ;(0, _interactjs2.default)(draggableChildrenSelector)
          .draggable({
    ...
    },
    {
      ...
      value: function componentWillUpdate(nextProps, nextState) {
        ...
        if (moveTransitionDuration) {
          var itemsRefs = (0, _union2.default)(
            ["placeholder"],
    ...
    },
    {
      ...
      value: function componentDidUpdate(prevProps, prevState) {
        ...
        if (moveTransitionDuration) {
          ...
          if (
            placeholderEl &&
            (0, _get2.default)(prevState, "placeholder.rank") &&
            (0, _get2.default)(prevState, "placeholder.rank") !==
              (0, _get2.default)(this.state, "placeholder.rank")
          ) {
            (function() {
              var itemsRefs = (0, _union2.default)(
                ["placeholder"],
              ...
              itemsRefs.forEach(function(itemRef) {
                ...
                if (el) {
                  ...
                  el.style.webkitTransform = el.style.transform = el.style.msTransform =
                    "translate(" + x + "px, " + y + "px)" // move back to former position
                  instructions.transitions.push(function() {
                    el.style.WebkitTransition = el.style.transition =
                      "transform " + moveTransitionDuration + "s"
                  })
    ...
    },
    {
      ...
      value: function _dragMove(event) {
        ...
        if (draggedEl && state.dragging) {
          ...
          draggedEl.style.webkitTransform = draggedEl.style.transform = draggedEl.style.msTransform =
            "translate(" + 0 + "px, " + y + "px)"
        } else {
          // Dragging has just started, store original position
          state.dragging.top =
            target.offsetTop - parseInt(getStyle(target, "margin-top"), 10)
          state.dragging.left =
            target.offsetLeft - parseInt(getStyle(target, "margin-left"), 10)
    ...
    },
    {
      ...
      value: function _dragEnd(event) {
        ...
        if (
          draggedBefore &&
          draggedAfter &&
          draggedBefore.rank === draggedAfter.rank &&
          dropBackTransitionDuration
        ) {
          draggedEl.style.WebkitTransition = draggedEl.style.transition =
            "all " + dropBackTransitionDuration + "s" // no transition
        }
    ...
    },
    {
      ...
      value: function _movePlaceholder(e) {
        ...
        children.forEach(function(child) {
          newPlaceholder = _this6._calculatePlaceholder(
            child,
            mouseX,
            mouseY,
            newPlaceholder,
        ...
        if (
          newPlaceholder &&
          (!placeholder || newPlaceholder.rank !== placeholder.rank)
        ) {
          this.setState({
    ...
    },
    {
      ...
      value: function _calculatePlaceholder(
        child,
        mouseX,
        mouseY,
        placeholder,
        ...
        if (type === "grid") {
          ...
          distance =
            type === "vertical" ? Math.abs(distanceY) : Math.abs(distanceX)
